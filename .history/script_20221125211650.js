...
worksMobile.map((element) => { 
  ...
  works +=
    ` <div style="margin-bottom: 70px;" class="feature-work" id="${'feature-work-popup' + element.id}">
        ...
        <div class="featured-work-text">
          ...
          <button type="button" class="featured-work-button" id="${'featured-work-button' + element.id}" onclick="${this.openFeatureWorkPopup(element.id).bind(this)}">See Project</button>
        </div>
      </div>`
  ...
  <div class="featured-works-popup" id="${'featured-works-popup' + element.id}">
      ...
      <div class="featured-works-popup-heading">
        ...
        <i class="fas fa-close" onclick="${this.openFeatureWorkPopup(element.id).bind(this)}"></i>
      </div>
